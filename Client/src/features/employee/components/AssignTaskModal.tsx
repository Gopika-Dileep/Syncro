...
export default function AssignTaskModal({ isOpen, onClose, onAssign, taskTitle, teamId }: AssignTaskModalProps) {
            ...
            <div className="bg-white rounded-3xl w-full max-w-[360px] overflow-hidden shadow-2xl border border-gray-100 animate-in fade-in zoom-in duration-200">
                ...
                <div className="p-5">
                    <p className="text-[11px] text-gray-400 mb-4 px-1">
                        Select a team member to handle <span className="text-[#1f2124] font-bold">"{taskTitle}"</span>
                    </p>
