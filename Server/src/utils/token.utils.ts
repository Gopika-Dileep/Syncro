...
export const generateAccessToken =(userId:string,role:string, permissions:string[]=[])=>{
    return jwt.sign({id:userId,role, permissions},env.ACCESS_TOKEN_SECRET,{expiresIn:"15m"})
}
