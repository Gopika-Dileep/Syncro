...
container.bind<IGetProfileService>(TYPES.GetProfileService).to(GetProfileService);
container.bind<IChangePasswordService>(TYPES.ChangePasswordService).to(ChangePasswordService);
container.bind<IUpdateUserProfileService>(TYPES.UpdateUserProfileService).to(UpdateUserProfileService);
...
container.bind<ICreateUserStoryService>(TYPES.CreateUserStoryService).to(CreateUserStoryService);
container.bind<IGetUserStoriesByProjectService>(TYPES.GetUserStoriesByProjectService).to(GetUserStoriesByProjectService);
container.bind<IGetUserStoryByIdService>(TYPES.GetUserStoryByIdService).to(GetUserStoryByIdService);
container.bind<IUpdateUserStoryService>(TYPES.UpdateUserStoryService).to(UpdateUserStoryService);
container.bind<IDeleteUserStoryService>(TYPES.DeleteUserStoryService).to(DeleteUserStoryService);
